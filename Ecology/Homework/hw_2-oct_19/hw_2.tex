...
\end{code}
and the results are $r_0 \approx 0.04$ for pre-1971 data and $r_0 \approx -0.048$ for post-1970 data.  This means the population will go extinct if the current weather patterns continue, and suggest that further variation could lead to even faster extinction.
